                            ...
                            <table id="example1" class='table table-hover table-condensed'>
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  if ($row['proses']=='0'){ $proses = '<i class="text-danger">Pending</i>'; }elseif($row['proses']=='1'){ $proses = '<i class="text-warning">Konfirmasi</i>'; }elseif($row['proses']=='2'){ $proses = '<i class="text-info">Packing</i>'; }else{ $proses = '<i class="text-success">Dalam Pengiriman </i>'; }
                                  echo "<tr><td>$no</td>
